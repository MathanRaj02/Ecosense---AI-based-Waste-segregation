...
arduino_port = 'COM7'  # Replace 'COMX' with the actual COM port of your Arduino
...
# Define the pin where the LED is connected (use the actual )
led_pin = board.get_pin('d:13:o')  # Digital pin 13 as an output
...
while True:
    ...
    if predictions:
        ...
        # Control the LED based on the category_number
        for _ in range(category_number):
...
# Release the camera and close the Arduino connection
